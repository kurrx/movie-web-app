...
type Component = typeof SubContent
type Ref = ElementRef<Component>
type RefProps = ComponentPropsWithoutRef<Component>

export type DropdownMenuSubContentProps = RefProps

export const DropdownMenuSubContent = forwardRef<Ref, DropdownMenuSubContentProps>(
