...
export interface WatchInfoButtonProps extends RefProps, PropsWithChildren {
...
export const WatchInfoButton = forwardRef<Ref, WatchInfoButtonProps>(
  function WatchInfoButton(props, ref) {
    const {
      children,
      Icon,
      active = false,
